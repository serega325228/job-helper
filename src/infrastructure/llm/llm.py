...
def get_router(self, config: LLMConfig | None = None) -> tuple[Router, LLMConfig]:
    ...
    with self._router_lock:
        if self._router is None or self._router_config_key != key:
            _router = _build_router(self._config)
